...
const Hobbies = () => (
  <div className="text-center">
    ...
    <h4 className="text-fourth">
      ...
      {' '}I have over 40 pairs of shoes in my collection, some of them very rare. I am also very active I like to play
      basketball, kayak, bike and play soccer. When I am feeling a bit lazy, I watch the English Premier League, NFL,
      NBA, NHL and MMA. I play video games ranging from Fifa to Call of Duty.
    </h4>
    <HobbyImages />
  </div>
);
