...
(
    <div>
        <h1 className='text-third'><strong>Hobbies <FontAwesomeIcon icon={faBasketball} className='fa-bounce' /></strong></h1>
      ...
      <h4 className="text-third">
        ...
        my problem solving techniques. To view some of my skills please look at the cards below.
      </h4>
    </motion.div>
    </div>
